...
import { Settings, Sparkles, Users, Plus, LogOut } from 'lucide-react';
            ...
            <div className="workspace-selector-container">
                <header className="workspace-header">
                    ...
                    <div className="user-section">
                        ...
                        <button className="btn-icon" onClick={() => setIsProfileModalOpen(true)} title="Settings">
                            <Settings size={20} />
                        </button>
                    ...
                    {workspaces.map((workspace) => (
                        ...
                        >
                            <div className="workspace-card-content">
                                <h4 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Sparkles size={18} className="text-accent" /> {workspace.name}</h4>
                                <p>{workspace.description || 'No description provided.'}</p>
                            </div>
                            <div className="workspace-card-meta" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                <Users size={14} /> {workspace.members?.length || 1} Member(s)
                            </div>
                        </div>
                    ))}
                    
                    <form className="create-workspace-card" onSubmit={handleCreateWorkspace}>
                        <h4 className="create-workspace-title" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Plus size={18} /> Create Workspace</h4>
                        <input
                            type="text"
